...
This document describes version 0.04 of Business::BankCard::Indonesia (from Perl distribution Business-BankCard-Indonesia), released on 2014-08-16.
...
=item * B<ind_description.in> => I<array>
...
=item * B<ind_description.not_in> => I<array>
...
=item * B<issuer_id.not_in> => I<array>
...
Source repository is at L<https://github.com/sharyanto/perl-Business-BankCard-Indonesia>.
